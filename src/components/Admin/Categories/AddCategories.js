        ...
        return (
            <Modal {...this.props} size="lg" aria-labelledby="contained-model-title-vcenter" centered>
                <Modal.Header closeButton>
                    <Modal.Title id="contained-model-title-vcenter">Add AddCategory</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                            ...
                            <Col sm={6}>
                                <Form onSubmit={this.handelSubmit}>
                                    ...
                                    <Form.Group controlId="name">
                                        ...
                                        <Form.Control type="text" name="name" placeholder="Category name" required />
                                    </Form.Group>

                                    <Form.Group controlId="code">
                                        <Form.Label>Category code</Form.Label>
                                        <Form.Control type="text" name="codee" placeholder="Category codee" required />
                                    </Form.Group>
