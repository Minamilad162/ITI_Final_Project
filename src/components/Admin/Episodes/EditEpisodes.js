        ...
        return (
            <Modal {...this.props} size="lg" aria-labelledby="contained-model-title-vcenter" centered>
                <Modal.Header closeButton>
                    <Modal.Title id="contained-model-title-vcenter">Edit Episode</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                            ...
                            <Col sm={6}>
                                <Form onSubmit={this.handelSubmit}>
                                    ...
                                    <Form.Group controlId="number">
                                        ...
                                        <Form.Control type="text" name="number" placeholder="number" value={this.props.number} />
                                    </Form.Group>

                                    <Form.Group controlId="thumbnail_url">
                                        <Form.Label>Thumbnail url</Form.Label>
                                        <Form.Control type="text" name="thumbnail_url" placeholder="Thumbnail url" value={this.props.thumbnail_url} />
                                    </Form.Group>
                                    ...
                                    <Form.Group controlId="seasons">
                                        ...
                                        <Form.Control type="text" name="seasons" placeholder="seasons" value={this.props.seasons} />
                                    </Form.Group>
